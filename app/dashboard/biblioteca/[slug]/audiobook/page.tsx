...
import { ArrowLeft, Headphones, CheckCircle2, ArrowRight, Mic } from 'lucide-react'
        ...
        {livroGerado ? (
          <>
            ...
            <p style={{ fontSize: 15, color: '#6a7a96', lineHeight: 1.7, margin: '0 0 32px' }}>
              Escolha uma voz brasileira e a Aurora narra cada capítulo com qualidade de estúdio.
            </p>
            <Link href={`/dashboard/biblioteca/${slug}/audiobook/criar`}
              style={{
              ...
              <Mic style={{ width: 18, height: 18 }} /> Criar Audiobook
            </Link>
          </>
        ) : (
          <>
            ...
            <p style={{ fontSize: 15, color: '#6a7a96', lineHeight: 1.7, margin: '0 0 32px', maxWidth: 480 }}>
              Pra ouvir seu livro narrado por vozes profissionais em português, primeiro precisamos escrever seu livro.
              É rápido — em poucos minutos os capítulos ficam prontos e o Audiobook é desbloqueado automaticamente.
            </p>
            ...
            <div style={{
              ...
              {[
                'Narração premium, capítulo por capítulo',
                '8 vozes brasileiras de estúdio',
                'Pronto pra Spotify, Audible e mais',
              ].map((item, i) => (

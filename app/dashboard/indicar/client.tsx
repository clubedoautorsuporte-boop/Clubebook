  ...
  return (
    <div className="px-5 py-6 pb-12 md:px-8 max-w-2xl">
      ...
      <div className="mb-7 flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-bold text-[#344767]">Indique e Ganhe</h1>
          <p className="text-sm text-[#7b809a]">1 ebook grátis para você + 500 créditos para o amigo</p>
        </div>
      </div>
      ...
      <div className="mb-6 grid gap-3 sm:grid-cols-3">
        {[
          ...
          <div key={n} className="rounded-2xl border border-[#e9ecef] bg-white p-4">
            ...
            <p className="text-xs font-semibold text-[#344767]">{titulo}</p>
            <p className="mt-0.5 text-[11px] leading-relaxed text-[#7b809a]">{texto}</p>
          </div>
        ))}
      </div>
      ...
      <div className="mb-4 rounded-2xl border border-[#00e5c320] bg-[#00e5c306] p-5">
        <p className="mb-3 text-sm font-semibold text-[#344767]">Seu link exclusivo de indicação</p>
        <div className="flex gap-2">
          <div className="flex-1 overflow-hidden rounded-xl border border-[#e9ecef] bg-[#f0f2f5] px-4 py-2.5 text-sm">
        ...
        <div className="mt-3 flex items-center gap-1.5 text-[11px] text-[#9ca3af]">
          ...
          <span>Código: <span className="font-mono text-[#9ca3af]">{refCode}</span></span>
        </div>
      </div>
      ...
      <div className="rounded-2xl border border-[#e9ecef] bg-white p-5">
        <div className="mb-4 flex items-center gap-2">
          ...
          <p className="text-sm font-semibold text-[#344767]">Compartilhar agora</p>
        </div>
        <div className="grid gap-2 sm:grid-cols-2">
          ...
          <button
            onClick={copy}
            className="flex items-center justify-center gap-2 rounded-xl border border-[#e9ecef] bg-[#f0f2f5] py-3 text-sm font-semibold text-[#7b809a] transition hover:border-[#4f7fff40] hover:text-[#344767]"
          >
      ...
      <div className="mt-4 rounded-2xl border border-[#4f7fff20] bg-[#4f7fff08] p-5">
        <p className="mb-3 text-sm font-semibold text-[#344767]">Suas recompensas</p>
        <div className="grid gap-2 sm:grid-cols-3">
          {[
            ...
            <div key={r.meta} className="rounded-xl border border-[#e9ecef] bg-[#f0f2f5] p-3 text-center">
              <p className="text-[10px] text-[#9ca3af]">{r.meta}</p>
              <p className={`mt-0.5 text-xs font-bold ${r.cor}`}>{r.recompensa}</p>
            </div>
          ))}
        </div>
        <p className="mt-3 text-center text-[10px] text-[#9ca3af]">Sistema de recompensas em implementação. Suas indicações são rastreadas.</p>
      </div>
    </div>
  )
}

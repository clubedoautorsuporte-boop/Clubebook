...
export default async function DashboardPage() {
  ...
  // ── Busca créditos SEMPRE frescos do banco ─────────────────────────────
  ...
  if (userId || email) {
    try {
      // Busca por userId OU por email (garante entregas antigas sem userId)
      ...
      // Deduplica entregas (pode aparecer por userId E email)
  ...
  // Atividades recentes: ebooks + rascunhos ordenados por data
